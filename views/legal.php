...
<![endif]--> 
  ...
  <body>
   ...
   <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Legal disclaimer<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <img src="imatges/about/linia_vermella.png" width="3" height="16"><a href='javascript:window.print(); void 0;'><img src="imatges/about/print.png" width="16" height="14" style="margin-right:10px; margin-left:10px;"></a><!--<img src="imatges/about/linia_vermella.png" width="3" height="16">
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/legal.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/legal.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/legal.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      <div class="span6" style="float:none; margin-left:0px;">
      <h1 class="tipo_titol1">— LEGAL DISCLAIMER</h1>
      </div>
      <h1><hr></h1>
...
<p class="tipo_bio_text">This website is property of the BioRegion of Catalonia Private Foundation (Biocat), fiscal identification number G-64166747 and business address at passeig de Gràcia, number 103, 3rd floor, in Barcelona.<br><br>

Use of this website is subject to the conditions laid out in the following document. Accessing this website and using the materials it contains implies that the user has read and accepts these conditions, without exception. In some cases, use of specific areas or services on this website may be subject to special conditions, for example the "Press" section.<br><br>

All information provided by users of this website will be used exclusively for the express purpose explained in each case and will be treated according to technological and organizational security measures established by current legislation.<br><br>

<strong>Responsibilities of the BioRegion of Catalonia Private Foundation</strong><br>
Continued access to the elements and information contained in this website, the ability to view them correctly or to download them may be impeded, hindered or interrupted due to factors beyond Biocat's control. Biocat will not be held responsible for any damage or loss to arise as a result of telephone malfunctions or power failures and/or any other factor or circumstance beyond its control. The material that appears on this site is solely for informational purposes, users must take into account that they may not reflect the most recent data on the issues analyzed. Biocat does not guarantee that the information contained in this website is truthful, updated and not erroneous. Likewise, these materials may be modified, developed or updated with no prior notification. The links on this website may take users to external websites managed by third parties, over which Biocat has no control.<br><br>

<strong>Responsibilities of the users</strong><br>
Users of this website do so at their own risk. Biocat will not be held responsible for any damage that arises from use of the website, nor any actions carried out based on the information provided therein.<br><br>

Users are not authorized to use contents from this website for commercial or advertising purposes.<br><br>

Links to or from this page do not imply any type of relationship, collaboration or support for this entity. Links that fraudulently induce or establish any kind of relationship with this entity will not be allowed. Links from defamatory, pornographic, racist or xenophobic sites will not be authorized, nor will those that offer false information about the entity or any of its collaborators.<br><br>

<strong>Jurisdiction and Applicable Laws</strong><br>
This legal disclaimer is subject to current Spanish legislation. Any conflict that may arise as to the interpretation of the conditions established in this disclaimer will be resolved in the Barcelona legal system.<br><br>

<strong>Intellectual Property</strong><br>
All contents of this website –which is understood include but is not restricted to: texts, photographs, graphics, images, links and other audiovisual or sound contents, in addition to the graphic design and source code of the website itself– are the intellectual property of Biocat or third parties and are protected by current Spanish legislation on intellectual and industrial property.
Materials may only be exploited with express prior consent from Biocat and must always make explicit reference to Biocat's ownership of the intellectual property rights on said materials. Biocat reserves the right to modify the terms and conditions established in this document.<br><br>

<strong>Personal Data Protection</strong><br>
Some of the services offered on this website require users to provide personal information. Users will be warned during the process that they will have to provide these details and that it will be impossible to provide the desired service without them.<br>
Cookies or other similar systems that store information and allow users to be identified will never be used.<br><br>

User information that reaches Biocat, via e-mail, CVs, or general queries, will be considered confidential. In the case of queries, the information will be used only to respond to the questions posed, for CVs the information will be used only for candidate selection.<br><br>

Biocat saves the personal information it collects and will adopt the necessary measures to avoid the loss, alteration or non-authorized access and use of said data. Users may exercise their right to access, correct, delete or oppose by contacting the Communications and Institutional Relations Department at the aforementioned street address or at <span class="tipo_bio_text_link"><a href="mailto:info@biocat.cat">info@biocat.cat</a></span>.<br><br></p>
