...
<![endif]-->  
  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Design Health Barcelona<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/admissions.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/admissions.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/admissions.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
     </h1> 
     ...
     <h1 class="tipo_menu_bio_titol">Design Health Barcelona<br> application process<br><br></h1>
     <p class="tipo_menu_bio" style="border: 5px solid #6dc5a0; text-align:center; font-size:16px; padding:10px;"><strong>Online application deadline for the Class of 2013-2014: Sun, 16 June 2013</strong></p>
     <br><br>

     <p class="tipo_agenda_text3" style="color:#6dc5a0;"><strong><a href="moebio_descarga.pdf">1. INTRODUCE YOURSELF: THE ONLINE APPLICATION</a></strong><br></p>
     <p class="tipo_agenda_text3" style="color: #4C4D4F;">Before starting to fill in the online application form, make sure to organize all your application materials:<br><br> 

— Personal information, including DNI/NIE/Passport number<br>
— Academic information:<br>
— Diploma, Certificate of Graduation or Degree Transcript for any University 
     curriculum attended (PDF)<br>
— Transcripts from all undergraduate and graduate academic institutions that 
     you have attended (full- or part-time), (PDF).<br>
— Transcript or Certificate of participation to extra-curriculum courses, if any (PDF)<br>
— Other activities, such as research, publications, etc. if any (PDF)<br>
— Curriculum Vitae (2 pages maximum, in PDF)<br>
— 2 letters of recommendation (PDF)<br>
— 2 personal essays (PDF)<br>
— Personal 3-min video<br><br>

Please note that everything has to be uploaded online, there is no need to mail us anything.
<a href="moebio_descarga.pdf">Learn more</a>  about each component to be submitted in your online application.<br><br>
</p> 


 <p class="tipo_agenda_text3" style="color:#6dc5a0;"><strong>2. TELL US MORE: THE INTERVIEWS
</strong><br></p>
     <p class="tipo_agenda_text3" style="color: #4C4D4F;">Interviews are only by invitation, following a thorough review of the completed application.<br>
Instructions are provided at the time of invitation.<br>
There are only 20 spots for this selected program. <br>
Selected candidates are invited to meet us in Barcelona for two interviews taking place during the week starting on 17th, June.  The first interview is meant to assess your technical skills, while the second one is meant to test your interpersonal and creativity skills.<br><br>

The exact dates will be communicated to each candidate. Note that in case of exceptional circumstances, these interviews can be conducted over the web. 
</p>
<hr>


<p class="tipo_agenda_text3" style="color: #4C4D4F;">Questions about this process may be directed to <a href="mailto:admissions-dhealth@moebio.org">admissions-dhealth@moebio.org</a>
<br><br>
</p> 
      ...
      <div id="backgroundpastilla_videos" style="max-height:774px;">
      <div class="pull-left">
     ...
     <img src="imatges/picto_calendari.png" width="19" height="22" style="margin-right:10px; padding-left:25px;">
       ...
       <p span class="tipo_menu8" style=" max-width:240px; padding-left:25px;">STARTING DATE: <span class="tipo_menu9">September 2013</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
...
<img src="imatges/about/pastilla_dreta_puntes.png" width="296" height="46"> 
      ...
      <div class="span_pastilla" style="float:right; max-width:296px;">
      ...
      <div class="span_pastilla" style="float:right; max-width:296px; margin-bottom:30px;">
      <div id="backgroundpastilla" style="margin-top:50px; padding-left:10px; padding-top:10px; padding-bottom:5px;">
       <div class="pull-left">
       <img src="imatges/picto_download.png" width="22px" height="auto" style="margin-right:10px;">
       </div>
