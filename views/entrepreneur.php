...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Short Focused Programs > Entrepreneur XXI<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/entrepreneur.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/entrepreneur.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/entrepreneur.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      <div class="span6" style="float:none; margin-left:0px;">
      <h1 class="tipo_titol1">— ENTREPRENEUR XXI</h1>
      </div>
      <h1><hr></h1>
      <p class="pull-right" style="margin-top:-30px; margin-right:40px;"><img src="imatges/label2.png" width="45" height="97"></p>
...
A cualquier persona con inquietud por ver cómo el mundo digital afecta a la actividad de marketing le quedará claro, en estas 3 horas, el proceso a seguir para no equivocarse.<br><br>
    ...
    <div class="span_pastilla">
     ...
     <img src="imatges/picto_calendari.png" width="19" height="22" style="margin-right:10px; padding-left:25px; padding-top:30px;"">
       ...
       <p span class="tipo_menu8_focused" style=" max-width:240px; padding-left:25px; padding-top:30px;">ONE DAY <span class="tipo_menu9"> Program</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
       
       <div class="pull-left">
       <img src="imatges/picto_rellotge.png" style="margin-right:10px;  padding-left:25px;">
       </div>
       <p span class="tipo_menu8_focused" style=" max-width:240px; padding-left:25px;">STARTING DATE: <span class="tipo_menu9">Mon, 16 September 2013</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
       ...
       <p span class="tipo_menu8_focused"  style=" max-width:240px; padding-left:25px;">PROFILES: <span class="tipo_menu9">Graduates and PhDs in Health, Bio, Tech, Business and Design.</span></p>
     ...
     <img src="imatges/picto_dollar.png" width="19" height="22" style="margin-right:10px; padding-left:25px; padding-top:0px;">
       ...
       <p span class="tipo_menu8_focused" style=" max-width:240px;padding-left:55px; padding-right:20px; padding-top:0px;">PRICE <span class="tipo_menu9"> 450 €</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
     ...
     <img src="imatges/picto_places.png" style="margin-right:10px; padding-left:25px; padding-top:0px;">
       ...
       <p span class="tipo_menu8_focused" style=" max-width:240px; padding-left:25px; padding-top:0px;">PLACES AVAILABLE <span class="tipo_menu9">English/Catalan/Spanish</span></p>
      ...
      <p style="margin:0px; text-align:center;"><a href="http://applicationsform.moebio.org/"><img src="imatges/apply_mostassa.png" onmouseover="this.src='imatges/apply_red2.png'"
onmouseout="this.src='imatges/apply_mostassa.png'" style="margin-top:20px;"></a></p>
