...
<!-- google analytics-->
  ...
  (function() {
    ...
    <link href="moebio2.css" rel="stylesheet" type="text/css"/>
...
<![endif]--> 
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
          ...
          <div class="nav-collapse collapse">
            ...
            <li class="tipo_menu1"><a href="#" target="_blank">COMMUNITY</a></li>
             ...
             <div id="rat">|</div>
              ...
              <div id="rat">|</div>
              <li class="tipo_menu1"><a id="search_button" href="#" style="border:none;"><img src="imatges/home/search_small.jpg" width="11" height="11"> SEARCH</a>
    ...
    <div id="search_container">
      ...
      <img src="imatges/search_gros2.png" width="356" height="66" style="margin-top:40px; margin-bottom:40px;">
      ...
      <div class="container">
        ...
        <div class="span8">
          <img src="imatges/reel_moebio2.gif" width="736" height="423"></div>
          
          <div class="span5">
        <h2 span class="tipo_menu14">LOOKING FOR VISIONARIES</h2>
        <h2 span class="tipo_menu15">We are a disruptive talent 
initiative where healthcare, 
business, technology 
& design meet.</h2>
 <p><a href="the_initiative.php"><img src="imatges/knowmoreverd.png" onmouseover="this.src='imatges/knowmorevermell.png'"
onmouseout="this.src='imatges/knowmoreverd.png'" style="margin-top:10px;"></a></p>
        ...
        <div class="span3">
          <a href="the_initiative.php"><h2 class="tipo_menu3"><img src="imatges/redarrow.png" width="10" height="auto" style="margin-top:-5px;"> WHY</h2>
          <p  class="tipo_menu4">To empower leaders who can transform society and make 
a better future.</p></a>
          
        </div>
        <div class="span3">
          <a href="the_initiative.php"><h2 class="tipo_menu3"><img src="imatges/redarrow.png" width="10" height="auto" style="margin-top:-5px;"> HOW</h2>
          <p class="tipo_menu4">Training a new generation of entrepreneurs to solve widespread global needs in the healthcare system.</p></a>
          
       </div>
        <div class="span3">
          <a href="the_initiative.php"><h2 class="tipo_menu3"><img src="imatges/redarrow.png" width="10" height="auto" style="margin-top:-5px;"> WHAT</h2>
          <p class="tipo_menu4">A 8 months full time Design Health course and short focused programs.</p></a>
          
        </div>
        <div class="span3" style="border:none;">
          <a href="the_initiative.php"><h2 class="tipo_menu3"><img src="imatges/redarrow.png" width="10" height="auto" style="margin-top:-5px;"> FOR WHOM</h2>
          <p class="tipo_menu4">Graduates and PhDs in Health, Bio, Tech, Business and Design.</p></a>
      ...
      <h1>
       ...
       <div class="row-fluid" style="margin-bottom:75px; margin-top:50px;">
        ...
        <img src="imatges/home/cross/watch-1.jpg" width="231" height="auto" alt="" />
        <div class="img-info2" >
        
            <h4 style="margin-left:10px; margin-right:10px; display: inline-block;" >MULTINOMICS</h4>
        ...
        <div class="img-info2" >
            ...
            <h4 style="margin-left:10px; margin-right:10px;" >D:HEALTH</h4>
        ...
        <div class="img-info2" >
            ...
            <h4 style="margin-left:10px; margin-right:10px;" >BUSCIENCE</h4>
        ...
        <div class="img-info2" >
            ...
            <h4 style="margin-left:10px; margin-right:10px;" >TECHNOMICS</h4>
      ...
      <h1>
       ...
       <div class="row-fluid" style="margin-bottom:75px; margin-top:50px;">
        ...
        <div class="span3" style="border:none;  margin-bottom:30px;" >
         <a href="#">
        ...
        <div id="desc_cross1"><p class="btn">MULTINOMICS</p></div>
       
        </div>
        
        <div id="img_cross_verd">
        
        <img src="imatges/verd_petita.png" width="234" height="132">
        <div id="desc_cross2"><p class="btn">MULTINOMICS</p></div>
      ...
      <div class="span6" style="float:none; margin-top:30px;  margin-left:0px;">
       ...
       <img src="imatges/lineabio.png" width="647" height="3" style="margin-top:0px;">
...
onmouseout="this.src='imatges/learn_red.png'" style="margin-top:30px;"></a></p>
       ...
       <div class="span3" style="margin-top:25px;">
        <div id="video_image">
       <img src="imatges/video_home.jpg" width="296" height="170">
     ...
     <div class="video-container"><iframe src="http://player.vimeo.com/video/65852671" width="573" height="322" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
       ...
       <div class="pull-left">
     <img src="imatges/picto_calendari.png" width="19" height="22" style="margin-right:10px; margin-top:25px;"></div>
       <p span class="tipo_menu8" style="margin-top:25px; ">8 MONTH <span class="tipo_menu9">Full Time Program</span></p>
       <p><img src="imatges/lineabio_small.png"></p>
       <div class="pull-left">
       <img src="imatges/picto_rellotge.png" style="margin-right:10px;">
       </div>
       <p span class="tipo_menu8">STARTING DATE: <span class="tipo_menu9">September 2013</span></p>
       <p><img src="imatges/lineabio_small.png"></p>
       <div class="pull-left">
       <img src="imatges/picto_profile.png" style="margin-right:10px;  margin-bottom:30px;">
       </div>
      
       <p span class="tipo_menu8">PROFILES: <span class="tipo_menu9">Graduates and PhDs in Health, Bio, Tech, Business and Design.</span></p>
      
      <a href="admissions.php"><img src="imatges/apply_green.png" onmouseover="this.src='imatges/apply_red.png'"
...
Innovation does not take place in isolation. Truly productive invention is a team sport that requires the collaboration of minds from myriad perspectives. In the next decade we all will need to become Collinovators.</p>
       ...
       <a href="#"><img src="imatges/home/highlights/button_verd.png" onmouseover="this.src='imatges/home/highlights/button_vermell.png'"
onmouseout="this.src='imatges/home/highlights/button_verd.png'" style="margin-top:30px; margin-bottom:30px;"></a>
       ...
       <img src="imatges/home/highlights/video_highlights.jpg" width="485" height="auto">
...
<img src="imatges/home/thoughts/img_video.jpg" width="224" height="123"> 
<a href="#">
...
<img src="imatges/home/latest_tweets/bocata_gris.png" width="223" height="150">
