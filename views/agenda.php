...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Agenda<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="views/imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/agenda.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="views/imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/agenda.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="views/imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/agenda.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
...
<a href="agenda/detail/<?= $item['id'] ?>/<?= generate_seo_link($item['title']) ?>"><?= $item['title'] ?></a>
</p>
<a href="agenda/detail/<?= $item['id'] ?>/<?= generate_seo_link($item['title']) ?>">
...
<p class="tipo_agenda_verd">
<a href="#">
Biovision Investor Conference 2013
</a>
</p>
<a href="#">
...
<p class="tipo_agenda_verd">
<a href="#">
BIO-Europe Spring 2013 (7th Annual International Partnering Conference)
</a>
...
-->
   <hr>
   <p class="pull-right"><img src="views/imatges/thoughts/point_grey.png" onmouseover="this.src='imatges/thoughts/point_red.png'" onmouseout="this.src='imatges/thoughts/point_grey.png'"  width="8" height="8" style="margin-left:5px;"><img src="views/imatges/thoughts/point_grey.png" onmouseover="this.src='imatges/thoughts/point_red.png'" onmouseout="this.src='imatges/thoughts/point_grey.png'"  width="8" height="8" style="margin-left:5px;"><img src="views/imatges/thoughts/point_red.png" width="8" height="8" style="margin-left:5px;"></p>
   </div>
   
   <div class="span3" style="margin-top:0px;">
   
   <div class="span_pastilladreta offset1" style="margin-top:0px; margin-left:0px; max-width:240px; ">
      <div id="backgroundpastilla">
      <h2 class="tipo_menu3" style="padding-left:25px; padding-top:20px;">— ARCHIVE</h2>
       
    

<div class="accordion" id="accordion2">
<div class="accordion-group">
<div class="accordion-heading" style="padding:0px;">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
<p span class="tipo_menu8" style="padding-left:0px;"> 2012 <span class="pull-right"><img src="views/imatges/archive_arrow.png" width="9" height="7"></span></p>
</a>
</div>
<div id="collapseOne" class="accordion-body collapse in">
<div class="accordion-inner">
 <img src="views/imatges/about/linia_pastilla2.png" width="180" height="3" style="padding-left:0px;">
          <p class="tipo_menu4" style=" max-width:200px; padding-left:0px;">
          January<br>
February<br>
March<br>
April<br>
...
<p class="tipo_menu8" style="padding-left:0px;">2013 <span class="pull-right"><img src="views/imatges/archive_arrow.png" width="9" height="7"></span></p>
</a>
</div>
...
December<br>
      ...
      <img src="views/imatges/about/pastilla_dreta_puntes.png" width="296" height="46" style="margin-top:-27px;"></div>
