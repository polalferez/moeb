...
<![endif]-->  
  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Contact <div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <img src="imatges/about/linia_vermella.png" width="3" height="16"><a href='javascript:window.print(); void 0;'><img src="imatges/about/print.png" width="16" height="14" style="margin-right:10px; margin-left:10px;"></a><!--<img src="imatges/about/linia_vermella.png" width="3" height="16">
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/contact.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/contact.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/contact.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      ...
      <h1 class="tipo_titol1">— CONTACT</h1>
      </div>
      <h1><hr></h1>
      <div class="span_contact">
      <p class="tipo_contact">If you have a question for us, we might have an answer for you.<br><br>
 
The simplest way to reach us is by e-mail at <a href="mailto:info@moebio.org">info@moebio.org</a> but you can also phone us:<br><br>
</p>
      <p class="tipo_contact2">Moebio</p>
      <p class="tipo_contact3">Biocat, Passeig de Gràcia 103- 3rd floor<br> 
08008 Barcelona (Spain)<br>
Phone: +34 933 10 33 30<br>
<a href="mailto:info@moebio.org">info@moebio.org</a><br>
<a href="mailto:press@moebio.org">press@moebio.org</a> (media contact)<br><br></p>
      </div>
...
<div id="backgroundwantto" style="margin-top:100px;">
