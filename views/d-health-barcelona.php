...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Full Time programs  >  d·HEALTH Barcelona > What is d·HEALTH Barcelona<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/d-health-barcelona.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/d-health-barcelona.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/d-health-barcelona.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h2 class="tipo_menu_bio" style="margin-top:0px; margin-bottom:0px;">What is d·HEALTH Barcelona</h2>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <h1 class="tipo_menu_bio_titol" style="padding-bottom:30px;">What is d·HEALTH Barcelona</h1>
       <p class="tipo_menu_bio_titol" style="color: #6DC5A0; font-weight:bold; font-size:24px;"><em>"Probably the most impressive accelerator/
fellowship program we've seen emerge in Europe"</em></p>
<p class="tipo_bio_text" style="color:#EC1C24;">HealthStartup Europe<br><br><br></p>

       <p class="tipo_bio_text">Design Health Barcelona is the flagship of MOEBIO. A Higher Education Program inspired in the prestigious Stanford University's Biodesign Fellowship.<br><br>
       Since 2001, the Stanford Biodesign program has graduated over 120 Fellows and 700 students who have started
26 companies, raising over $200
million and creating over 500 new
jobs. More importantly, far more than 150.000 patients have been treated by technologies invented by our trainees.<br><br>
       Design Health Barcelona is a pioneering initiative. It is a new educational model of training health transformers.<br><br>
       Design Health Barcelona seeks change-makers. It takes the initiative to solve real, global, major challenges in the healthcare and medical technologies industries starting up new, innovative business models, products and services.<br><br>
       Design Health Barcelona is a fabric of future leaders. It guides participants beyond their boundaries. It teaches them to think outside the box to identify new opportunities and develop the advancing technologies that will set the future of medical practice and will positively impact people' lives.<br><br>
Design Health Barcelona acts as a catalyst across fields It brings together top students, leading researchers, brilliant entrepreneurs, great investors and innovative organizations and acts as an ignitor fire to make amazing things happen.<br><br>

Design Health Barcelona is disruptive, dynamic, entrepreneurial, social, global, creative, vital, inspiring, enthusiastic, innovative and challenging.<br><br>

Design Health Barcelona is not molecular or genetic research, outdated case studies, a place for lonely individuals. 
</p>
        <hr style="margin-top:30px; margin-bottom:30px;">
     
       <h1 class="tipo_titol_bio_verd" style="margin-bottom:30px;">OUR GOALS</h1>
       <p class="tipo_bio_comillas"><img src="imatges/bio/comillas_cites.png" width="22" height="20" style="margin-top:-10px; margin-right:10px;">You can't change the world with the same kind of consciousness that created most of those challenges in the first place."  Albert Einstein.</p><br>
       <p class="tipo_bio_text">The purpose of Design Health Barcelona is to develop an innovative ecosystem to address significant clinical challenges. Our goals are:<br><br>

- Change the face of education, training innovators in the healthcare industry.<br>
- Accelerate startups & boost entrepreneurs.<br>
- Develop solutions to overcome real, unmet healthcare needs.<br>
- Incorporate new products and services into the health systems.<br></p>
<hr style="margin-top:30px; margin-bottom:30px;">



        <h1 class="tipo_titol_bio_verd" style="margin-bottom:30px;">WHAT DO FELLOWS GET</h1>
       <p class="tipo_bio_comillas"><img src="imatges/bio/comillas_cites.png" width="22" height="20" style="margin-top:-10px; margin-right:10px;">Life isn't about finding yourself. Life is about creating yourself."  
George Bernard Shaw.</p><br>
       <p class="tipo_bio_text">Being a Design Health Barcelona fellow is a life-changing experience. Fellows discover new ways of thinking and working imbuing in the amazing creativity and entrepreneurial spirit of Barcelona. 
It is a personally and professionally rewarding experience.<br><br>
Design Health Barcelona fellows get:<br>
— A proven method to innovate in healthcare.<br>
— A competitive edge in the job market.<br>
— The opportunity to work with an international network of renowned, creative minds in the healthcare and medical technologies industries.<br>
— The boost to step to entrepreneurship.<br>
— Continuous support to help their innovation projects become a reality.<br>
— The connection to the resources needed for the advancement of their idea.<br>
— A playful and intellectually stimulating environment to accelerate their personal growth.<br><br>

We also value fellows' lives outside the work and we help support the move to Barcelona. 
<br><br><br>
       </p>
