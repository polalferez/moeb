...
<![endif]--> 
  ...
  <body>
   ...
   <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Search results<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <img src="imatges/about/linia_vermella.png" width="3" height="16"><a href='javascript:window.print(); void 0;'><img src="imatges/about/print.png" width="16" height="14" style="margin-right:10px; margin-left:10px;"></a><!--<img src="imatges/about/linia_vermella.png" width="3" height="16">
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/search_results.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/search_results.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/search_results.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      <div class="span6" style="float:none; margin-left:0px;">
      <h1 class="tipo_titol1">— SEARCH RESULTS</h1>
      </div>
      <h1><hr></h1>
      <p class="tipo_search_results1">Showing 1 of 123 results<br><br></p>
      
     <p class="tipo_search_results2">d·Health Barcelona Program</p>
     <p class="tipo_search_results3">.... CIO of the Global Viral Forecasting Initiative, he talks about d·Health how to improve medical education, preparing students to solve, non-linear, exponential problems Pis archilicia suntios dolorem et est harchilla volent et pro tem rempell oritiaerum hicit dolestrum eumqui cus sim expel ....</p>
     <p class="tipo_search_results4"><a href="#">www.moebio.org/dhealthbarcelona</a></p><br><br>
