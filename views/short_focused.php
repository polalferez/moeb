...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Short Focused Programs<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/short_focused.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/short_focused.ph&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/short_focused.ph&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h1 class="tipo_titol1">— SHORT FOCUSED PROGRAMS</h1>
      </div>
      <h1><hr></h1>
...
The target audience of Biocapsules are young entrepreneurs, department heads at consolidated companies and other professionals interested in expanding their areas of expertise to biotechnology. Once the programme finished they had acquired the tools to recognize opportunities and disruptive influences within biotechnology and to understand how this rapidly developing and converging field will affect the future of wellness, prevention, clinical practice and the biomedical industry.<br><br></p>
      ...
      <div class="span4">
      <div class="span_focused" style="margin-right:12px;">
     
      <div class="span_focused_int">
      <p class="tipo_agenda_titol_focused">ENTREPRENEUR XXI</p>
...
<img width="77" height="auto" src="imatges/knowmore_mostassa.png" style="cursor:pointer;" onmouseover="this.src='imatges/agenda/moreinfo_vermell.png'" onmouseout="this.src='imatges/knowmore_mostassa.png'">
</a>
<hr>
</div>
</div>
