...
<!-- google analytics-->
  ...
  (function() {
    ...
    <link href="views/moebio.css" rel="stylesheet" type="text/css"/>
    <link media="only screen and (max-device-width: 480px)" href="views/iphone.css" 
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="views/assets/ico/apple-touch-icon-114-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="72x72" href="views/assets/ico/apple-touch-icon-72-precomposed.png">
                    <link rel="apple-touch-icon-precomposed" href="views/assets/ico/apple-touch-icon-57-precomposed.png">
                                   ...
                                   <link rel="shortcut icon" href="views/imatges/favicon/favicon_MOEBIO.ico">
...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="index"><img src="imatges/logo.png" width="216" height="71"></a>
      ...
      <h1 class="tipo_fil">Courses  >  Specialized Tracks > Creative leadership<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/creative_leadership.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/creative_leadership.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/creative_leadership.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      <div class="span6" style="float:none; margin-left:0px;">
      <h1 class="tipo_titol1">— CREATIVE LEADERSHIP</h1>
      </div>
      <h1><hr></h1>
      <p class="pull-right" style="margin-top:-30px; margin-right:40px;"><img src="imatges/label3.png" width="45" height="97"></p>
      ...
      <div class="span_pastilladreta" style="width:296px; margin-top:30px; height:20px; ">
      <h2 class="tipo_menu_bio" style="margin-top:0px; margin-bottom:0px;"></h2>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <p class="tipo_bio_text"><strong>Dirigido a:</strong> ejecutivo de cuentas, business developer manager, senior 
brand manager, manager marketing, ejecutivo de marketing, director 
de comunicación, ecommerce senior, ecommerce executive, emprendedores<br><br>

<strong>Nivel:</strong> medio<br><br>

<strong>Formato de la clase:</strong> master class<br><br>

<strong>Duración:</strong> 3 horas<br><br>

<strong>¿Qué se lleva el alumno?</strong><br>
Se lleva un roadmap (proceso) para iniciar mañana mismo en su empresa la transformación digital. Este proceso afecta a variables de comunicación, de venta, revisión de procesos internos y a la transformación cultural de la empresa.<br><br>
</p>
<hr>

<p class="tipo_bio_text">
<strong>Descripción</strong><br>
Vivimos en una época donde el impacto digital está transformando todas las empresas. Se habla de social media, de e-commerce, del poder de los consumidores, de la importancia de los contenidos… en definitiva, se habla de demasiadas cosas. En un contexto con tanto ruido es fundamental tener una visión panorámica para poder priorizar la actividad de marketing y dirigirla adecuadamente para obtener el máximo provecho del mundo digital.<br><br>

 En este curso se abordarán las cuatro grandes areas a las que afecta el marketing digital:<br>
Comunicación: ¿cómo cambia la comunicación de las empresas por la entrada de un medio como internet? ¿Qué objetivos nos ayuda a conseguir? ¿En qué plataformas debería estar presente? ¿Cómo priorizo?<br>
Venta:  se habla de e-commerce y se piensa en tener una tienda propia para gestionar envíos, pero ¿es la única alternativa?<br>
Cambio de procesos & organigrama: la entrada de nuevas actividades implica una revisión de las actuales. Si estamos en facebook y alguien se queja, ¿quién debería responder? La base de datos, ¿de quien depende? ¿Cómo transformamos los mensajes de los consumidores en fuente de innovación?<br>
Cambio de cultura: la digitalización implica formar a los equipos en habilidades y en conocimientos. ¿Cuál debería de ser el proceso? ¿Cómo lo priorizamos? ¿Qué recursos deberíamos dedicarle?<br>
A cualquier persona con inquietud por ver cómo el mundo digital afecta a la actividad de marketing le quedará claro, en estas 3 horas, el proceso a seguir para no equivocarse.<br><br>
</p>
    ...
    <div class="span_pastilla">
      <div class="span_pastilla" style="float:right; min-width:296px; max-width:296px;">
       ...
       <div class="pull-left">
     <img src="imatges/picto_calendari.png" width="19" height="22" style="margin-right:10px; padding-left:25px; padding-top:30px;"">
     </div>
       <p span class="tipo_menu8_focused_turquesa" style=" max-width:240px; padding-left:25px; padding-top:30px;">ONE DAY <span class="tipo_menu9"> Program</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
       
       <div class="pull-left">
       <img src="imatges/picto_rellotge.png" style="margin-right:10px;  padding-left:25px;">
       </div>
       <p span class="tipo_menu8_focused_turquesa" style=" max-width:240px; padding-left:25px;">STARTING DATE: <span class="tipo_menu9">Mon, 16 September 2013</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
       ...
       <p span class="tipo_menu8_focused_turquesa"  style=" max-width:240px; padding-left:25px;">PROFILES: <span class="tipo_menu9">Graduates and PhDs in Health, Bio, Tech, Business and Design.</span></p>
      
      <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
      
      
       <div class="pull-left">
     <img src="imatges/picto_dollar.png" width="19" height="22" style="margin-right:10px; padding-left:25px; padding-top:0px;">
     </div>
       <p span class="tipo_menu8_focused_turquesa" style=" max-width:240px;padding-left:55px; padding-right:20px; padding-top:0px;">PRICE <span class="tipo_menu9"> 450 €</span></p>
       <p><img src="imatges/about/linia_pastilla2.png" width="240" height="3" style="padding-left:25px;"></p>
       
       
       <div class="pull-left">
     <img src="imatges/picto_places.png" style="margin-right:10px; padding-left:25px; padding-top:0px;">
     </div>
       <p span class="tipo_menu8_focused_turquesa" style=" max-width:240px; padding-left:25px; padding-top:0px;">PLACES AVAILABLE <span class="tipo_menu9">English/Catalan/Spanish</span></p>
      ...
      <p style="margin:0px; text-align:center;"><a href="http://applicationsform.moebio.org/"><img src="imatges/apply_turquesa.png" onmouseover="this.src='imatges/apply_red2.png'"
onmouseout="this.src='imatges/apply_turquesa.png'" style="margin-top:20px;"></a></p>
