...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/what_is_dhealth.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/what_is_dhealth.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/what_is_dhealth.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
...
<br><br><br>
 ...
 <h1 class="tipo_titol_bio_verd" style="margin-bottom:30px; font-size:18px;">COLLABORATORS<br><hr style="margin-top:5px;"><br><br>
         <img src="imatges/logos/logo_clinic.jpg" width="101" height="61" style="margin-right:30px; margin-bottom:20px;"> <img src="imatges/logos/logo_guttman.jpg" width="151" height="51" style="margin-right:30px; margin-bottom:20px;"><img src="imatges/logos/logo_st.joan.jpg" width="211" height="33"><br><br><br></h1>
        
       
       <h1 class="tipo_titol_bio_verd" style="margin-bottom:30px; font-size:18px;">WITH THE SUPPORT OF<br><hr style="margin-top:5px;"><br><br>
       
         <img src="imatges/logos/logo_hub.jpg" width="166" height="106"><br><br><br> </h1>
