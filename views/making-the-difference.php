...
<![endif]--> 
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Full Time programs  >  d·HEALTH Barcelona > Making the difference<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <img src="imatges/about/linia_vermella.png" width="3" height="16"><a href='javascript:window.print(); void 0;'><img src="imatges/about/print.png" width="16" height="14" style="margin-right:10px; margin-left:10px;"></a><!--<img src="imatges/about/linia_vermella.png" width="3" height="16">
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/making-the-difference.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/making-the-difference.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/making-the-difference.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h2 class="tipo_menu_bio"  style="margin-top:0px; margin-bottom:0px;">Making the difference</h2>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <h1 class="tipo_menu_bio_titol" style="padding-bottom:30px;">Making the difference</h1>
        <p class="tipo_bio_comillas"><img src="imatges/bio/comillas_cites.png" width="22" height="20" style="margin-top:-10px; margin-right:10px;">A lot of people never use their initiative, because no-one told them to."  Banksy.<br><br>
        What did Alexander Wood have in mind when he pioneered 
the hypodermic syringe?<br>
Would you like to get the world's applause as he did?<br>
Do you dare to challenge the status quo?<br>
        
        </p><br>
       <p class="tipo_bio_text">We all have the potential to innovate. 
Design Health Barcelona brings out the entrepreneur in fellows by:<br><br>
— Combining an academic program and real experiences in healthcare business.<br>
— Working real: real problems, real needs, real people and real-life scenarios.<br>
— Breaking boundaries of disciplines to connect health, business, technology & design 
at a new and unknown level.<br>
— Catalysing new business, products and services.<br> 
— Acting as an educational incubator of leaders.<br>
— Fostering creative team working.<br>
— Having fun and working hard.<br><br>
