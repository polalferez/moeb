...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Specialized tracks<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/specialized_tracks.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/specialized_tracks.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/specialized_tracks.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h1 class="tipo_titol1">— SPECIALIZED TRACKS</h1>
      </div>
      <h1><hr></h1>
  <p class="pull-right" style="margin-top:-30px; margin-right:40px;"><img src="imatges/label3.png" width="45" height="97"></p>
      
      <p class="tipo_bio_text">Each Biocapsule is a one-day session in which participants acquire skills they can immediately apply 
in their daily responsibilities. The sessions, results-driven and for a maximum of 20 participants, 
are taught by world-class professionals combining theory practice through hands on experiences, 
demos and in-depth discussions.<br><br>

<strong>The goals of the sessions are:</strong><br>
To learn new ways to valuate start-ups in order to be more competitive.<br>
To draft a communication plan to valuate the company and product, as well as adapting it to each stakeholder.<br>
To review and implement industrial property strategy.<br>
To draw up a project, taking into consideration the risks and decision points.<br>
To select marketable projects to which efforts should be devoted<br><br>

<strong>Biocapsules are geared towards:</strong><br>
The target audience of Biocapsules are young entrepreneurs, department heads at consolidated companies and other professionals interested in expanding their areas of expertise to biotechnology. Once the programme finished they had acquired the tools to recognize opportunities and disruptive influences within biotechnology and to understand how this rapidly developing and converging field will affect the future of wellness, prevention, clinical practice and the biomedical industry.<br><br></p>
      ...
      <div class="span4">
      <div class="span_special" style="margin-right:12px;">
     
      <div class="span_special_int">
      <p class="tipo_agenda_titol_focused_turquesa">ENTREPRENEUR XXI</p>
      <img src="imatges/courses/focused/img_focused.jpg" width="297" height="163">
      <p class="tipo_focused_preu" style="margin-top:20px;"><img src="imatges/courses/focused/picto_dollar.png" width="8" height="12"> 430 € | <img src="imatges/courses/focused/picto_calendar.png"> March 2013</p>
      <p class="tipo_agenda_text">Anias perume sum site eum nonsequis qui quatestibus sitatio quamus estium quis ipid esecum ut qui tem reri quatest, cuptata sincit aliquiat.</p>
      <a href="creative_leadership.php">
<img width="77" height="auto" src="imatges/knowmore_turquesa.png" style="cursor:pointer;" onmouseover="this.src='imatges/agenda/moreinfo_vermell.png'" onmouseout="this.src='imatges/knowmore_turquesa.png'">
</a>
<hr>
</div>
</div>
