...
<![endif]-->  
 ...
 <div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <h1 class="tipo_fil">About Moebio  > Cross-concepts > Collinovate<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
   ...
   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/collinovate.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/collinovate.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/collinovate.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <p class="tipo_agenda_titol">ALFONS CORNELLA</p>
       
       <p class="tipo_bio_text" style="margin-bottom:30px;">Velentem earum est, ulliquam, solupta a peris doluptas recte nulparci ut ut eum assequia veliatqui od estibus. Expedis et ab ipsam, volorro bla nus volore lam il estorpo rentotatem. Ni is sus, con exerum quo velitio ribusantius quatat pellorios ipsandus con pe omnis endus. Imaiorerat fugiaest, quos volectis sit ipsuntum doluptaque num.
</p>

       <img src="imatges/about/cross_concepts/img_int_cross.png" width="648" height="366">
       
       <p class="tipo_text_bio_collapse" style="margin-top:20px; margin-bottom:40px;">
       <img src="imatges/share_gris.png" width="39" height="9" style="margin-right:10px;">
  <img src="imatges/about/advisory/picto_in.png" width="16" height="16"> <img src="imatges/about/advisory/picto_f.png" width="16" height="16"> <img src="imatges/about/advisory/picto_t.png" width="16" height="16"></p>
   ...
   <div class="span6" style="float:none; margin-top:0px;  margin-left:0px;">
       <h1 span class="tipo_menu10">— MORE CROSS CONCEPTS</h1>
