...
<![endif]--> 
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Full Time programs  >  d·HEALTH Barcelona > Learning by being challenged<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/learning-by-being-challenged.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/learning-by-being-challenged.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/learning-by-being-challenged.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h2 class="tipo_menu_bio" style="margin-top:0px; margin-bottom:0px;">Learning by being challenged</h2>
      <h2 class="tipo_menu_bio2" style="margin-top:0px; margin-bottom:0px;"><a href="becoming-a-fellow.php">Becoming a fellow</a></h2>
      <h2 class="tipo_menu_bio2" style="margin-top:0px; margin-bottom:0px;"><a href="the-program.php">The program</a></h2>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <h1 class="tipo_menu_bio_titol" style="padding-bottom:30px;">Learning by being challenged</h1>
        <p class="tipo_bio_comillas"><img src="imatges/bio/comillas_cites.png" width="22" height="20" style="margin-top:-10px; margin-right:10px;">Life begins at the end of your comfort-zone."  Neal Donald Walsh.<br><br>
        
        
        </p><br>
       <p class="tipo_bio_text">We shape the world through the paradigms we use to describe it. Only when we observe with new consciousness we can find different answers and fresh solutions to problems. 
Demanding the "right" answers to tests as the current education system does, does not encourage people to be adventurous in finding new ways to do things, or to question existing systems. It is "action" learning within the real world, with real challenges, in real-life assignments and with real companies, the strongest form of acquiring new knowledge.
<br><br>
Biodesign innovation -or the identification, invention, and implementation of new medical technologies- is a discipline that can be learned. The biodesign innovation process has been developed by Stanford University's Program in Biodesign over a decade to help both novel and experienced innovators increase their likelihood of success. It provides them the tools, resources, and information to help them effectively apply the biodesign innovation process to real-world or class-based projects.<br><br><br>
To date, it has been used to:<br><br>
— Advise more than a hundred project teams at Stanford.<br>  
— Launch numerous venture-backed companies.<br>
— Bring devices into practice that have been used to treat thousands of patients.<br></p>
<hr style="margin-top:30px; margin-bottom:30px;">



<p class="tipo_bio_text"><strong>Design Health Barcelona</strong> shares this same spirit of Stanford's Biodesign innovation process. It works at the interfaces of Science and Business, using a X-Thinking approach to facilitate and accelerate healthcare entrepreneurship.<br><br>

<strong>X-Thinking</strong> is a combination of human-centered, prototype-driven tools and methods that, in conjunction with the scientific and business knowledge, provide fellows with the skills, values, attitudes and behaviours necessary to produce disruptive solutions to tackle any complex challenge. Every aspect of the Design Health Barcelona's learning model, from participant selection, to teams dynamics, to social activities, to classroom settings, has been carefully crafted to encourage fellows to work creatively and be enterprising under this X-thinking principle.<br><br>

<strong>Science</strong>, because it is the way to be truly game-changing and solve some of the greatest challenges in healthcare. It is not about learning the best practices but to invent and train in the next practices: the ones that already do not exist or are in the labs today and will likely come into the market in the next three to five years.<br><br>

<strong>Business</strong>, because it is essential to the success of the new ventures. Participants will learn how to think about all the parts for building a successful business.
<br></p>
<hr style="margin-top:30px; margin-bottom:30px;">


<p class="tipo_bio_text">The Design Health Barcelona learning model is based on five elements:<br><br>

<strong>On-location learning</strong><br>
An eleven weeks-long clinical immersion, in which fellows work side-by-side with physicians, nurses and patients at different clinical settings in Barcelona (Hospital Clínic Barcelona, Sant Joan de Déu Hospital and Institut Guttmann), focusing on real-life challenges. They learn to identify needs and new business opportunities.<br><br>

<strong>Lectures</strong><br>
Delivered by academics from some of the best institutions in the world and by experienced professionals in governments and industries. Stanford University, Singularity University, KaosPilots and many more are our first-class partners.<br><br>
Our faculty works directly with fellows, providing guidance to find and develop sustainable business models by connecting them with strategic partners.<br><br>


<strong>Internal Workshops & Group Dynamics</strong><br>
Fellows participate in informal and formal talk-shops, open space, peer-to-peer dialogues, feedback and listening tools.
<br><br>

<strong>E-Learning & MOOCs</strong><br>
Fellows learn theory at home from selected online, open access, outstanding contents and share the gained knowledge in the classroom. Design Health Barcelona's outstanding faculty help them to successfully apply what they have learned in the development of their innovative ideas.<br><br>

<strong>External activities</strong><br>
Every year, over 2,000 international and national workshops, courses, conferences, conventions and incentive trips take place in Barcelona. Fellows take advantatge of this living ecosystem and are able to attend the most interesting meetings to improve their learning process.<br><br>
...
<div class="span_learning offset_learning1">
  <p><img src="imatges/bio/learning/bola1_learning.png" width="38" height="auto"></p>
  <p><img src="imatges/bio/learning/linia_learning_verda.png" width="193" height="auto"></p>
  <p class="tipo_learning">
  <strong>On-location learning</strong><br>
Clinical immersion 
at Hospital Clinic Barcelona, 
Hospital Sant Joan de Déu, 
Institut Guttmann.
  </p>
  </div>
<div class="span_learning offset_learning2">
<p><img src="imatges/bio/learning/bola2_learning.png" width="38" height="auto"></p>
<p><img src="imatges/bio/learning/linia_learning_verda.png" width="193" height="auto"></p>
<p class="tipo_learning">
<strong>Lectures</strong><br>
Renowned experts from 
Stanford Biodesign, FutureMed 
(Singularity University), Kaos Pilot 
and many more.
  </p>
</div>
<div class="span_learning">
<p><img src="imatges/bio/learning/bola3_learning.png" width="38" height="auto"></p>
<p><img src="imatges/bio/learning/linia_learning_verda.png" width="193" height="auto"></p>
<p class="tipo_learning">
<strong>Internal workshops<br>
& group dynamics</strong><br>
Talk-shops, peer-to-peer 
dialogues and debates.
  </p>
</div>
<div class="span_learning">
<p><img src="imatges/bio/learning/bola4_learning.png" width="38" height="auto"></p>
<p><img src="imatges/bio/learning/linia_learning_verda.png" width="193" height="auto"></p>
<p class="tipo_learning">
 <strong>E-learning and MOOCs to:</strong><br>
Online, open access to
outstanding contents 
and later class discussions.
  </p>
</div>
<div class="span_learning">
<p><img src="imatges/bio/learning/bola5_learning.png" width="38" height="auto"></p>
<p><img src="imatges/bio/learning/linia_learning_verda.png" width="193" height="auto"></p>
<p class="tipo_learning">
 <strong> External activities</strong><br>
Take advantage of the vibrant, 
innovative Barcelona's scientific 
...
<img src="imatges/bio/img_learning by.jpg" width="646" height="384" style="margin-bottom:40px;">
