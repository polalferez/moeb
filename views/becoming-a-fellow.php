...
<div class="navbar navbar-inverse navbar-fixed-top"><!--header-->
      ...
      <h1 class="tipo_fil">Courses  >  Full Time programs  >  d·HEALTH Barcelona > Becoming a fellow<div class="dropdown pull-right">
...
onmouseout="this.src='imatges/about/share.png'" width="39" height="9" style="margin-right:10px;"></a>
    ...
    <img src="imatges/popup_share/logo_in.png" width="11" height="11"> <span class="tipo_popup_share"><a href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.moebio.org/becoming-a-fellow.php&title=moebio &summary=moebio & source= moebio" target="_new">  Linkedin</a></span><br>
    <img src="imatges/popup_share/logo_f.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://moebio.org/becoming-a-fellow.php&amp;p[images][0]=http://&amp;p[title]=moebio&amp;p[summary]=moebio">Facebook</a></span><br>
    <img src="imatges/popup_share/logo_t.png" width="11" height="11"> <span class="tipo_popup_share"><a target="_blank" href="https://twitter.com/intent/tweet?url=http://moebio.org/becoming-a-fellow.php&amp;text=moebio&amp;via=moebio">Twitter</a></span><br>
    </ul>
    </div>
      </h1>
      ...
      <h2 class="tipo_menu_bio" style="margin-top:0px; margin-bottom:0px;">Becoming a fellow</h2>
...
onmouseout="this.src='imatges/bio/want_verd_petit.png'" style=" padding-left:25px; margin-top:50px;"></p>
       ...
       <h1 class="tipo_menu_bio_titol" style="padding-bottom:30px;">Becoming a fellow</h1>
        
       <p class="tipo_bio_text">Are you an entrepreneurial innovator, a disruptive technophile, or an aspiring futurist interested in healthcare?

<br><br>
Design Health Barcelona admits up to 20 participants to each program, based on a minimum requirements and a combination of knowledge, skills, personalities and competences.<br><br><br>

Our Fellows are extraordinary people with any of the following requirements:<br><br>

— Have an undergraduate degree in Medicine/Life Sciences, Business/Economics, 
Engineering/IT or Design.<br> 
— Have a higher educational degree such as a Masters degree in science, a PhD 
or a post-doctorate training.<br>
— Want to make a turn in their professional careers and pursue innovation in healthcare.<br><br><br>

Our Fellows are also people who love to work in multidisciplinary teams and have:<br><br>

— An explorative mindset, purpose and passion.<br>
— International experience studying or working outside home country.<br>
— Sufficient proficiency in English.<br>
— A "can do-will do" attitude and commitment to explore and take risks to anticipate where things are heading in healthcare industry.<br>
— Excellent interpersonal skills.<br><br><br>

We support our Fellows in numerous ways, through coaching and skills workshops, seminar discussions with thought leaders in technology, medicine, business and design.<br><br>

Most importantly, the most valuable asset we offer Fellows is other Fellows. During the Program they work in multidisciplinary teams and learn from and to collaborate with each other.<br><br><br>
       ...
       <img src="imatges/bio/img_becoming a fellow.jpg" width="646" height="466" style="margin-bottom:60px;">
